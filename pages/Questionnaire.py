...
#Each question gathers data that is used for the subsequent calculation of a predicted grade range. Each information is thereby weighted differently, based on their importance (see Report.py).
